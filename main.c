 ...
 *
 * The readline() helper function and main parameters
 * were provided by the course instructor and are
...
int main (int argc, char** argv) {
  // Voiding unused parameters provided by course instructor
  (void) argc;
  (void) argv;
...
// Provided by course instructor to read a line from FILE* f
